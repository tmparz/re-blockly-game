...
const games = [
  ...
  { name: 'pond/tutor', number: ['g.Jd=function(a,b){this.h=this.m.i;', 'g.Jd=function(a,b){window.BlocklyTouchInput.open(this.Ob(),function(v){gd(this,v)}.bind(this));return;this.h=this.m.i;'] },
