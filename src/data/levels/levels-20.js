...
export const levels20 = [
{
    ...
    hint: "外層用 While（還沒到傳送門）。主規則是 If/Else：前方沒牆就前進；否則用另一個 If/Else 判斷左邊是否可走。",
    grid: { cols: 5, rows: 3 },
    start: { x: 0, y: 2, dir: "E" },
    goal: { x: 4, y: 0 },
    walls: [
  ...
  },
{
    ...
    title: "迷宮：左手貼牆法",
    concept: "迷宮通用規則",
    goalText: "用左手貼牆法通過彎曲迷宮：能左轉先左轉，前方可走就前進，否則右轉。",
    hint: "外層用 While（還沒到傳送門）。裡面先判斷左邊沒牆就左轉；接著用 If/Else：前方沒牆就前進，否則右轉。",
    grid: { cols: 5, rows: 5 },
    start: { x: 0, y: 4, dir: "E" },
    goal: { x: 4, y: 0 },
    walls: [
